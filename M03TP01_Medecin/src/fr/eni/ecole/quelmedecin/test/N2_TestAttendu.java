...
import fr.eni.quelmedecin.bo.MedecinComparatorSpecialite;
...
public class N2_TestAttendu {
	...
	public static void main(String[] args) {
		...
		Comparator<MedecinSpecialiste> medecinComparator = new MedecinComparatorSpecialite();
