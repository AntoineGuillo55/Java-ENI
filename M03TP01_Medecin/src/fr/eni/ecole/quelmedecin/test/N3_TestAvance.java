...
public class N3_TestAvance {
	...
	public static void main(String[] args) {
		...
		if(melanie instanceof MedecinGeneraliste) {
			((MedecinGeneraliste)melanie).orienter();
		}
		...
		Collections.sort(liste, Personne.getComparatorNomPrenom());
		...
		Collections.sort(liste, Personne.getComparatorNomPrenom().reversed());
		...
		Collections.sort(patients, Personne.getComparatorNomPrenom());
		System.out.println("====== affichage de la collection triee dans l'ordre croissant sur le nom et prenom =====");
		for (Patient p : patients) {
			System.out.print(patients.indexOf(p)+" - "+ p);
		}
		...
		Collections.sort(patients, Personne.getComparatorNomPrenom().reversed());
		System.out.println("===== affichage de la collection triee dans l'ordre decroissant sur le nom et prenom =====");
		for (Patient p : patients) {
			System.out.print(patients.indexOf(p)+" - "+ p);
		}
